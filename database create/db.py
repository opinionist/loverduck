...
cur.execute("CREATE TABLE IF NOT EXISTS auction (name TEXT, tire REAL DEFAULT 0, point REAL DEFAULT 0, coin INTEGER DEFAULT 500, position TEXT DEFAULT '미정', subposition TEXT DEFAULT '미정', intro TEXT DEFAULT '미정')")
