...
tet.execute("CREATE TABLE IF NOT EXISTS gamble (name TEXT, coin INTEGER DEFAULT 0, money INTEGER DEFAULT 0, ID INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT)")
tet.execute("CREATE TABLE IF NOT EXISTS auction (name TEXT, tire REAL DEFAULT 0, point REAL DEFAULT 0, position TEXT DEFAULT '미정', subposition TEXT DEFAULT '미정', intro TEXT DEFAULT '미정')")
